...
typedef struct
{
	...
	void* outDeviceHandle; // CUdevice or cl_device_id or ID3D12Device*
	void* outContextHandle; // CUcontext or cl_context
	void* outCommandQueueHandle; // CUstream or cl_command_queue or ID3D12CommandQueue*
...
/**
**	Access CUDA, OpenCL OR DirectX devices.
