...
#define kPrSDKSequenceInfoSuiteVersion		9
...
typedef struct 
{
	...
	*/
	...
	/**
	**	Get the LUT interpolation mtheod for the sequence.
	**
	**	@param	inTimelineID	the timeline instance data
	...
	*/
	...
	/**
	**	Get the auto tone map enabled setting  for the sequence.
	**
	**	@param	inTimelineID	the timeline instance data
	...
	*/
	...
	/**
	**	Get the SDR gamma setting  for the sequence.
	**
	**	@param	inTimelineID	the timeline instance data
