...
#include "PrSDKSetEnv.h"
	...
	#define PRSDK_DECLARE_HANDLE(name)	\
			struct name##__;				\
			typedef struct name##__ *name

		PRSDK_DECLARE_HANDLE(HINSTANCE);
		PRSDK_DECLARE_HANDLE(HBRUSH);
		PRSDK_DECLARE_HANDLE(HDC);
		PRSDK_DECLARE_HANDLE(HFONT);
		PRSDK_DECLARE_HANDLE(HHOOK);
		PRSDK_DECLARE_HANDLE(HICON);
		PRSDK_DECLARE_HANDLE(HKEY);
		PRSDK_DECLARE_HANDLE(HMENU);
		PRSDK_DECLARE_HANDLE(HMONITOR);
		PRSDK_DECLARE_HANDLE(HPALETTE);
		PRSDK_DECLARE_HANDLE(HRGN);
		PRSDK_DECLARE_HANDLE(HWND);

	#undef PRSDK_DECLARE_HANDLE
