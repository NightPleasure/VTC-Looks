...
typedef struct
{
	...
	RawColorProfileRec		ioProfileRec;	// for ICC and Predefined Color Spaces
	prSEIColorCodesRec		outSEICodesRec;	// H-265 and custom codes for HEVC, AVC, ProRes
} ColorSpaceRec;
...
typedef struct
{
	...
	prSEIColorCodesRec		seiCodesRec;	// H-265 and custom codes for HEVC, AVC, ProRes
} RawColorSpaceRec;
