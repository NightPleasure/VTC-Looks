...
PrPixelFormat_V210_422_10u_709_FullRange	= MAKE_PIXEL_FORMAT_FOURCC('v', '2', '1', 'f'),		// packed uncompressed 10 bit 422 YUV aka V210 709 colorspace

PrPixelFormat_P210_422_10u_709 = MAKE_PIXEL_FORMAT_FOURCC('p', '2', '1', '0'),		// biplanar uncompressed 10 bit 422 YUV in Rec. 709
...
PrPixelFormat_ARGB_4444_32f_Planar = MAKE_PIXEL_FORMAT_FOURCC('A', 'R', 'g', 'P'), // 32-bit per component planar ARGB
PrPixelFormat_RGB_444_32f_Planar = MAKE_PIXEL_FORMAT_FOURCC('R', 'G', 'B', 'P'), // 32-bit per component planar RGB
...
// 422 10-bit native hardware format.  Color-aware usage only, so just 1 format.
PrPixelFormat_Y210_422_10u_as16u_709 =					MAKE_PIXEL_FORMAT_FOURCC('y', '2', '1', '0'),		// Similar to YUYV/YUY2, 10 MSBs used
PrPixelFormat_Y210_422_10u_as16u_709_FullRange =		MAKE_PIXEL_FORMAT_FOURCC('y', '2', '1', 'f'),		// Similar to YUYV/YUY2, 10 MSBs used
