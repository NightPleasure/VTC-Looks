	...
	#include "PrGPU/KernelSupport/KernelMemory.h"
		...
		GF_KERNEL_FUNCTION(kCrossDissolve,
			...
			int flip )
		{
			...
			kCrossDissolve <<< gridDim, blockDim, 0 >>> ( (float4 const*) outBuf, (float4 const*) inBuf, (float4*) destBuf, outPitch, inPitch, destPitch, is16f, width, height, progress, flip );
