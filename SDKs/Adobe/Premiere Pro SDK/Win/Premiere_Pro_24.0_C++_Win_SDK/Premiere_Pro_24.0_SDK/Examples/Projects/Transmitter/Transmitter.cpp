...
public:
	...
	**
	*/
	static tmResult StartPushAudio(
		const tmStdParms* inStdParms,
		const tmInstance* inInstance,
		PrTime inStartTime,
		float inSpeed,
	...
	{
		return ((TransmitInstance*)inInstance->ioPrivateInstanceData)->StartPushAudio(
			inStdParms,
			inInstance,
			inStartTime,
			inSpeed,
	...
	**
	*/
	static tmResult PushAudio(
		const tmStdParms* inStdParms,
		const tmInstance* inInstance,
		const tmPushAudio* inPushAudio)
	{
		return ((TransmitInstance*)inInstance->ioPrivateInstanceData)->PushAudio(
			inStdParms,
			inInstance,
			inPushAudio);
	}
	...
	**
	*/
	static tmResult StopPushAudio(
		const tmStdParms* inStdParms,
		const tmInstance* inInstance)
	{
		return ((TransmitInstance*)inInstance->ioPrivateInstanceData)->StopPushAudio(inStdParms, inInstance);
	}

	/**
	**
	*/
	static tmResult SetStreamingStateChangedCallback(
		const tmStdParms* inStdParms,
		void* inContext,
		tmStreamingStateChangedCallback inCallback)
	{
		return ((TransmitPlugin*)inStdParms->ioPrivatePluginData)->SetStreamingStateChangedCallback(
			inStdParms,
			inContext,
			inCallback);
	}
	...
	**
	*/
	static tmResult EnableStreaming(
		const tmStdParms* inStdParms,
		prBool inEnabled)
	{
		return ((TransmitPlugin*)inStdParms->ioPrivatePluginData)->EnableStreaming(
			inStdParms,
			inEnabled);
	}
	...
	**
	*/
	static tmResult IsStreamingEnabled(
		const tmStdParms* inStdParms,
		prBool* outEnabled)
	{
		return ((TransmitPlugin*)inStdParms->ioPrivatePluginData)->IsStreamingEnabled(
			inStdParms,
			outEnabled);
	}
	...
	**
	*/
	static tmResult IsStreamingActive(
		const tmStdParms* inStdParms,
		prBool* outActive)
	{
		return ((TransmitPlugin*)inStdParms->ioPrivatePluginData)->IsStreamingActive(
			inStdParms,
			outActive);
	}
	...
	tmModule*	outModule)
{
	...
	if (inLoadModule)
	{
		...
		outModule->StartPushAudio = TransmitModule::StartPushAudio;
		outModule->PushAudio = TransmitModule::PushAudio;
		outModule->StopPushAudio = TransmitModule::StopPushAudio;
		outModule->SetStreamingStateChangedCallback = TransmitModule::SetStreamingStateChangedCallback;
		outModule->EnableStreaming = TransmitModule::EnableStreaming;
		outModule->IsStreamingEnabled = TransmitModule::IsStreamingEnabled;
		outModule->IsStreamingActive = TransmitModule::IsStreamingActive;
